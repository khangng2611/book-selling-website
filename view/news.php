...
<div class="container" data-aos="fade-up">
    ...
    <div class="row">
        ...
        <div class="card">
            ...
            <img src="../asset/img/news/news1.png" class="img-fluid"  width="500px;" />
            <a href="#!">
            ...
            <a href="/news/news1" class="btn btn-primary">Đọc thêm</a>
            </div>
        </div>
        </div>
        ...
        <div class="card">
            <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
            <img src="../asset/img/news/news2.jpg" class="img-fluid"  width="500px;" />
            <a href="#!">
                <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
            </a>
            </div>
            ...
            <a href="/news/news2" class="btn btn-primary">Đọc thêm</a>
            </div>
        </div>
        </div>
        ...
        <div class="card">
            <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
            <img src="../asset/img/news/news3.jpg" class="img-fluid" width="500px;" />
            <a href="#!">
                <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
            </a>
            </div>
            ...
            <a href="/news/news3" class="btn btn-primary">Đọc thêm</a>
            </div>
        </div>
        </div>
    </div>
    ...
    <div class="row" data-aos="fade-up">
        ...
        <div class="card">
            <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
            <img src="../asset/img/news/news4.jpg" class="img-fluid"  width="500px;" />
            <a href="/news/news4">
                <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
            </a>
            </div>
