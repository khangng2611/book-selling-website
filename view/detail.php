...
<div class="container-fluid">
            ...
            <li class="mb-5">
                ...
                <div class="collapse" id="typebook">
                    <ul class="btn-toggle-nav list-unstyled pb-1 small">
                        <a href="/book/truyentranh">Truyện tranh</a> <br>
    ...
    <section class="py-5 col-9">
        ...
        <h5 class="bd-title">
            <ul class="breadcrumb">
                <li><a href="/home" class="fs-4 p-2 text-decoration-none">Home</a> <span class="divider"> > </span></li>
                <li><a href="/book" class="fs-4 p-2 text-decoration-none">Books</a> <span class="divider"> > </span> </li>
                ...
                <div class="p-2 d-flex justify-content-start">
                    ...
                    ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <button type="submit" name="buy" class="mt-4 btn btn-outline-success">Mua ngay</button>
                        </div>
                        </form>
                        
                        <div class="d-flex justify-content-start mx-4 mb-2">
                        <?php
                            if (isset($data['addCartMsg'])) {
                                if ($data['addCartMsg'] == "Thêm vào giỏ hàng thành công !") {
                                    echo <<< _END
                                        <div style="color: green;"> Thêm vào giỏ hàng thành công !</div>
                                    _END;
                                } 
                                else if ($data['addCartMsg'] == "Thêm vào giỏ hàng không thành công !") {
                                    echo <<< _END
