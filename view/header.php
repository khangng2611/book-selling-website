  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md bg-dark navbar-dark">
      <div class="container-fluid" style="margin: 0 10px;">
        <a href="#" class="navbar-brand" style="margin-right:50px;"><img src="/bookstore/asset/img/logo.png" alt="" width="100px"></a>
        <button
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
          <ul class="navbar-nav">
            <li class="nav-item">
              <a href="/bookstore/home" class="nav-link">Home</a>
            </li>
            <li class="nav-item">
              <a href="/bookstore/about" class="nav-link">About</a>
            </li>
            <li class="nav-item">
              <a href="/bookstore/book" class="nav-link">Books</a>
            </li>
            <li class="nav-item">
              <a href="/bookstore/news" class="nav-link">News</a>
            </li>
            <li class="nav-item">
              <a href="/bookstore/contact" class="nav-link">Contact us</a>
            </li>
          </ul>
        </div>
        <form class="d-flex">
                ...
                <form action="/bookstore/user/login" method="POST">
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn-primary">
                      <a href="/bookstore/user/signup" style="text-decoration:none; color:white;">Chưa có tài khoản? Đăng kí</a>
                    </button>
