...
<div class="container-fluid rounded bg-white mt-5 mb-5">
    <div class="row">
        ...
        <div class="col-md-9 border-right">
            ...
            <div class="modal fade" id="create_book" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="/bookstore/book/add" method="POST" enctype="multipart/form-data">
            ...
            <div class="user_container">
                ...
                <td class="text-center">
                    <form action="/bookstore/book/show" method="POST">
                ...
                <td class="text-center"> 
                    <form action="/bookstore/book/delete" method="POST">
                    <input name='id' style="display:none;" value=<?php echo $row["id"]; ?>></input>
        ...
        <form action="/bookstore/book/edit" method="POST" enctype="multipart/form-data" enctype="multipart/form-data">
